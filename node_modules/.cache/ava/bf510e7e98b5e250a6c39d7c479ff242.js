...
(0, _ava2.default)('test success w/o strict', function (t) {
    var needs = _Needs({ strict: false });
...
(0, _ava2.default)('test failure w/o strict', function (t) {
    var needs = _Needs({ strict: false });
    var test = needs.params({
        a: 'int',
        b_: 'float',
...
(0, _ava2.default)('test success w/ strict', function (t) {
    var needs = _Needs({});
    var test = needs.params({
        a: 'int',
        b_: 'float',
...
(0, _ava2.default)('test failure w/ strict', function (t) {
